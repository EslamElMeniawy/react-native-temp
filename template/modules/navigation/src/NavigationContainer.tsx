...
import { navigationRef, push } from './NavigationUtils';
...
export default React.memo(() => {
  ...
  const twoFingerPress = Gesture.Tap()
    ...
    .runOnJS(true)
    .onEnd((_e, success) => {
      const isDebugScreensOpen =
        routeNameRef.current === 'debugMenu' ||
        routeNameRef.current === 'networkLogs';

      if (success && !isDebugScreensOpen) {
